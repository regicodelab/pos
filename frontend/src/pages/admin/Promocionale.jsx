...
const Promocionale = () => {
  ...
  const fetchProductsData = async () => {
    const data = await fetchProducts('promocionale');
    setProducts(data);
  }
      ...
      <div className="flex flex-col w-full py-10">
        ...
        <div className="flex items-center justify-between mb-10 mx-12">
          <h1 className="flex items-center text-2xl font-bold text-gray-800 tracking-tight">
            <img
              src="https://www.rivercreeresort.com/wp-content/uploads/2024/08/Kitchen-Half-Off-PPT-Internal-july.webp"
